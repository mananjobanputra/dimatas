var FormEditable = function () {
    ...
    var initAjaxMock = function () {
        ...
        $.ajax({
            url: config.siteUrl+config.pg_name,
    ...
    var initEditables = function () {
        ...
        $.fn.editable.defaults.url = config.siteUrl+config.pg_name;
        ...
        $('.link_text').editable({
			...
			if(/^(http:\/\/www\.|https:\/\/www\.)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/.test(value)){
					//return true;
				} else {
		...
		$('#admin_color,#dashboard_color').editable({
            prepend: "not selected",
            inputclass: 'm-wrap',
            source: [{
                    value: 'blue',
